...
function (_Slider) {
  ...
  function MiniSlider(container, next, prev, activClass, animate, autoplay) {
    _classCallCheck(this, MiniSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MiniSlider).call(this, container, next, prev, activClass, animate, autoplay));
  }
  ...
  _createClass(MiniSlider, [{
    ...
    value: function decorizeSlides() {
      ...
      this.slides.forEach(function (slide) {
        slide.classList.remove(_this.activClass);
...
var Slider = function Slider() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      _ref$activClass = _ref.activClass,
      activClass = _ref$activClass === void 0 ? "" : _ref$activClass,
